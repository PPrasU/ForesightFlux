...
<html lang="en">
  <head>
    ...
    <title>Admin | Input Petunjuk Penggunaan Import</title>
    <!-- DataTables -->
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="page-title-box">
                  <h4 class="page-title">Input Petunjuk Penggunaan Import</h4>
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item active">
                      Isine Buat Input Petunjuk Penggunaan Import 
                      <strong>
                        (Import Ya Ini, Bukan API loh ya). 
                      </strong>
                                ...
                                <div class="card-body px-5 py-4">
                                    ...
                                    <div style="margin-top: 10px">
                                        <div class="text-center mb-4">
                                            <h4 class="mt-0 header-title">Input Data Petunjuk Import</h4>
                                        </div>
                                    </div>
                    
                                    <form action="{{ route('admin.postpetunjukImport') }}" method="POST" enctype="multipart/form-data" id="apiData">
                                        @csrf
                                        {{-- Judul --}}
                                        ...
                                        <div style="margin-top: 20px">
                                            <a href="{{ route('admin.petunjukImport') }}" class="btn btn-outline-secondary btn-lg btn-block mt-3 py-2" >
                                                Balik, ndak jadi
                                            </a>
                                        </div>
                                    </form>
