...
<html lang="en">
  <head>
    ...
    <title>Admin | Petunjuk Penggunaan API</title>
    <!-- DataTables -->
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="page-title-box">
                  <h4 class="page-title">Petunjuk Penggunaan API</h4>
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item active">
                      Isine Buat Halaman Petunjuk Penggunaan API 
                      <strong>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h3 class="mt-0 header-title">Tabel Petunjuk Penggunaan API</h3>
                                    <div>
                                      <a href="{{ route('admin.inputpetunjukAPI') }}" class="btn btn-outline-primary waves-effect waves-light"> 
                                        Input Data
                                      </a>
                                    </div>
                                </div>
                                      ...
                                      @foreach ($data as $row)
                                          <tr>
                                              ...
                                              <td style="text-align: center">
                                                <a href="/admin/petunjuk-API/edit/{{ $row->id }}"
          ...
          button.addEventListener('click', function(e) {
              ...
              Swal.fire({
                ...
                if (result.isConfirmed) {
                        ...
                        window.location.href = "{{ route('admin.hapuspetunjukAPI', ['id' => '__ID__']) }}".replace('__ID__', id);
                    }
              });
          });
        });
