                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p>
                                                ...
                                                <strong>> Pilih MAPE terkecil, ingat α β γ training dan
                                                    testing</strong><br>
                                                <strong>> Edit tabel setting params agar nilai α β γ training dan
                                                    testing berisi dari hasil MAPE terbaik</strong><br>
                                                <strong>> Hapus hasil peramalan dan lakukan pra proses dan proses dari
                                                    awal lagi</strong><br>
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form id="optimizeForm" method="POST"
                                                    ...
                                                    @csrf
                                                    <button id="optimizeBtn" class="btn btn-primary mb-3"
                                                        type="submit">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <p class="mb-1"><strong>Training Testing (90:10):</strong>
                                                        {{ $best_results[90]['mape'] ?? 'N/A' }}%
                                                        (α={{ $best_results[90]['alpha'] ?? '-' }},
                                                        β={{ $best_results[90]['beta'] ?? '-' }},
                                                        γ={{ $best_results[90]['gamma'] ?? '-' }})
                                                    </p>
                                                    <p class="mb-1"><strong>Training Testing (80:20):</strong>
                                                        {{ $best_results[80]['mape'] ?? 'N/A' }}%
                                                        (α={{ $best_results[80]['alpha'] ?? '-' }},
                                                        β={{ $best_results[80]['beta'] ?? '-' }},
                                                        γ={{ $best_results[80]['gamma'] ?? '-' }})
                                                    </p>
                                                    <p class="mb-1"><strong>Training Testing (70:30):</strong>
                                                        {{ $best_results[70]['mape'] ?? 'N/A' }}%
                                                        (α={{ $best_results[70]['alpha'] ?? '-' }},
                                                        β={{ $best_results[70]['beta'] ?? '-' }},
                                                        γ={{ $best_results[70]['gamma'] ?? '-' }})
                                                    </p>
                                                    <p class="mb-1"><strong>Training Testing (60:40):</strong>
                                                        {{ $best_results[60]['mape'] ?? 'N/A' }}%
                                                        (α={{ $best_results[60]['alpha'] ?? '-' }},
                                                        β={{ $best_results[60]['beta'] ?? '-' }},
                                                        γ={{ $best_results[60]['gamma'] ?? '-' }})
                                                    </p>
                                                    <p><strong>Jenis Data:</strong> {{ $jenisData }} (Season Length:
                                                        {{ $seasonLength }})</p>
                                                ...
                                                @if (isset($grid_results) && isset($best_results))
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="datatable4"
                                                            ...
                                                            <tbody>
                                                                @foreach ($grid_results as $res)
                                                                    ...
                                                                    @endphp
                                                                    <tr
                                                                        class="{{ $isBest ? 'table-success fw-bold' : '' }}">
                                                                        <td class="text-center">{{ $res['training'] }}
                                                                        </td>
                                                                        <td class="text-center">{{ $res['testing'] }}
                                                                        </td>
                                                                        <td class="text-center">{{ $res['alpha'] }}
                                                                        </td>
                                                                        <td class="text-center">{{ $res['beta'] }}
                                                                        </td>
                                                                        <td class="text-center">{{ $res['gamma'] }}
                                                                        </td>
                                                        ...
                                                        <div class="alert alert-info">
                                                            Setiap baris <span class="fw-bold text-success">berwarna
                                                                hijau</span> menandakan kombinasi α, β, γ terbaik
                                                            berdasarkan MAPE untuk masing-masing <strong>persentase
                                                                training</strong>.
                                                        </div>
                                                    </div>
                                                @endif
