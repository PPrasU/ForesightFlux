                ...
                <div class="inner">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-12">
                            <div class="logo">
                                <a href="/"><img src="{{ asset('images/Logo.webp') }}" alt="Tempat logo"
                                        style="height: 55px; width: 180px;" /></a>
                            </div>
                                    ...
                                    <ul class="nav menu">
                                        ...
                                        <li class="d-none d-sm-block d-md-none">
                                            <a href="{{ route('dashboard') }}"
                                                class="btn btn-primary waves-effect waves-light">Menuju Dasbor</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                        ...
                        <div class="col-lg-2 col-12">
                            <div class="get-quote">
                                <a href="{{ route('dashboard') }}"
                                    class="btn btn-primary waves-effect waves-light">Dasbor</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <p>
                            ...
                            <a style="color: #1a76d1; text-decoration: underline;"
                                href="https://www.investing.com/crypto/currencies" target="_blank">
                                investing.com
                            </a>
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <b>
                            <b style="color: red">Penting:</b> Ubah bagian Date agar data urut menjadi tanggal terlama
                            (Awal) ke tanggal terbaru (Akhir)
                ...
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <p>
                            ...
                            01/01/2024 - 04/15/2025 dan kolom Date muncul baris pertama dari Jan 01, 2024 sampai Apr 15,
                            2025
                        </p>
                        <b>
                ...
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <p>
                            ...
                            proses peramalan nantinya. Proses peramalan hanya melakukan unggahan data yang sudah diunduh
                            sebelumnya.
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <p>
                            Setelah itu data csv didapatkan lalu menuju ke <strong>Dasbor➡️Pengambilan Data➡️Import
                                Data➡️Mulai Impor Data</strong>
                        </p>
                        <p>
                            Ikuti langkah-langkahnya agar dapat menuju ke halaman import data csv dari <a
                                href="investing.com" target="_blank">investing.com</a>
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <p>
                            Setelah itu masukkan nama kripto, jangka waktu data historis, dan file csv data historis
                            kripto yang sudah diunduh
                            sebelumnya.
                        </p>
                        <p>
                            Pastikan bahwa semua diisi, jika ada satu yang kosong nanti akan error. Setelah itu klik
                            tombol Import Filenya. Mungkin
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <p>
                            Setelah menunggu proses import, data akan tampil dalam bentuk tabel yang terdiri dari kolom
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <p>
                            Setelah itu klik tombol Pra-Proses Data Kripto untuk mengambil kolom Date dan Price,
                            melakukan standarisasi tanggal,
                            penanganan data hilang, dan yang lainnya.
                        </p>
                        <p>
                            Pra-Proses akan dilakukan oleh sistem, jangan lupa klik tombol "Ya". Kalau tidak maka data
                            nantinya belum bisa dilakukan peramalan.
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <p>
                            Setelah itu klik tombol "Proses Peramalan Kripto" untuk melakukan proses peramalan data
                            historis kripto.
                        </p>
                        <p>
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <p>
                            Hasil peramalan akan tampil berupa grafik dan juga tabel. Terdapat beberapa informasi
                            mengenai hasil peramalannya.
                            Jadi harap dibaca dan dimengerti.
                        </p>
                        <p>
                            Mengingat volatilitas pasar kripto yang sangat tinggi dan dipengaruhi oleh berbagai faktor
                            eksternal,
                            maka hasil peramalan ini tidak bersifat prediktif absolut. Hasil yang disajikan hanya
                            dimaksudkan
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <p>
                            Jika ingin melakukan peramalan dengan data historis kripto yang lain. Jangan lupa untuk
                            menghapus data yang
                            berada di halaman Hasil Peramalan dan Import Data CSV. Setelah itu ulangi
                            langkah-langkahnya.
                        </p>
                        <p>
                            Jika data yang sebelumnya masih ada, maka tidak dapat dilakukan peramalan, karena akan
                            menyebabkan error pada sistem.
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <p>
                            Pada halaman data API ini kalian tinggal memilih kripto apa yang di inginkan. Tapi data API
                            ini hanya menyediakan maksimum
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <p>
                            Setelah itu pilih kripto, jenis data, dan jangka waktunya. Santai saja jika memilih jenis
                            data harian ini sudah dibatasi
                            sebanyak 720, jadi jangan takut jika jangka waktu yang dipilih melebihi 720 data. Jangan
                            lupa untuk klik Pilih Kripto
                            (Disarankan memilih data harian)
                        </p>
                        <p>
                            Perlu diingat bahwa mungkin saja terdapat kesalahan penamaan nama kripto, karena penamaan
                            dilakukan secara manual soalnya
                            penyedia API yaitu Kraken API tidak menyediakan nama asli kriptonya. Proses mungkin agak
                            lama, jadi mohon bersabar ya!
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="choose-left">
                        ...
                        <p>
                            Data kripto dari API yang sudah dipilih akan tampil dalam bentuk tabel. Untuk penjelasan
                            kolom-kolomnya ada dibawah tabel ya!.
                        </p>
                        <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title">
                        ...
                        <img src="images/section-img.png" alt="#" />
                        <p>
                            <strong>2020–2025:</strong> Data dimulai dari 01 Januari 2020 <em>(jika ada)</em> sampai 31
                            Mei 2025<br>
                    ...
                    <div class="single-table">
                        <div class="table-head">
                            <div class="icon"
                                ...
                                <span
                                    style="font-size: 20px; font-weight: bold; color: #808080; position: relative; top: -2px;">
                                    atau
                                </span>

                                <a href="#top" onclick="scrollToTop(event)">
                                    <i class="icofont icofont-circled-up" style="cursor: pointer;"></i>
                                </a>
                            </div>
                        ...
                        <ul class="table-list">
                            <li class="cross">
                                <i class="icofont icofont-thumbs-down"></i>Masih ndak paham, ya mungkin ini bukan
                                buatmu 😅
                            </li>
                            <li class="cross">
                            ...
                            <li class="cross">
                                <i class="icofont icofont-thumbs-down"></i>Baca lagi dari atas (bisa pake button kanan
                                bawah otomatis keatas) 🫠
                            </li>
                            <li class="cross">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="copyright-content">
                            <p>
                                © {{ date('Y') }} ForesightFluxCP <span class="d-none d-sm-inline-block">- Proyek
                                    Tugas Akhir Putra Prasetya Utama (2118030) | Template by <a
                                        href="https://www.wpthemesgrid.com">wpthemesgrid.com</a></span>
                            </p>
                        </div>
                    </div>
                </div>
